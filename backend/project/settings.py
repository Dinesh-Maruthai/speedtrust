...
SECRET_KEY = 'django-insecure-=oy+s^2s=nm_eyf77@z!)0by0u^7gayo3r%u$zt_r3e=_!+hh5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '.railway.app', 'speedtrust-production.up.railway.app', '.elasticbeanstalk.com', '*']
...
# CORS Settings - ADD ALL OF THESE
...
# Preflight caching (optional - improves performance)
...
DEFAULT_FROM_EMAIL = 'Speed Trust <noreply@speedtrust.org>'
